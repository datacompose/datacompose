...
class TestInvisibleCharacterCleaning:
    ...
    def test_remove_zero_width_characters(self, create_session, input_val, expected):
...
class TestUnicodeNormalizationCleaning:
    ...
    def test_normalize_unicode(self, create_session, input_val, expected):
...
class TestWhitespaceCleaning:
    ...
    def test_normalize_whitespace(self, create_session, input_val, expected):
...
class TestContentRemovalCleaning:
    ...
    def test_remove_html_tags(self, create_session, input_val, expected):
...
class TestCharacterTypeCleaning:
    ...
    def test_remove_punctuation(self, create_session, input_val, expected):
...
class TestComprehensiveCleaning:
    ...
    def test_clean_for_comparison(self, create_session, input_val, expected):
